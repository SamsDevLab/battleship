...
import { handleBoatInComputerArr } from "../game/ai-boat-placement";
...
// export const handleBoatContainerClick = (event) => {
//   const closestContainer = event.target.closest("[data-container]");
...
// ******************************************************************
// ********** Handle Boat Placement on Start Screen Board ***********
// ******************************************************************
...
// export const handleHoverAddHighlight = (event) => {
//   if (event.target.dataset.board === "start-screen") return;
...
// export const handleHoverRemoveHighlight = (event) => {
//   if (event.target.dataset.board === "start-screen") return;
